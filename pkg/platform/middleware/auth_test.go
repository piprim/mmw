...
func TestBearerAuthMiddleware_ValidToken_InjectsUserID(t *testing.T) {
	userID := uuid.New()
...
func TestBearerAuthMiddleware_MissingToken_Returns401(t *testing.T) {
	validate := func(_ context.Context, _ string) (uuid.UUID, error) {
		return uuid.New(), nil
	}
...
func TestBearerAuthMiddleware_InvalidToken_Returns401(t *testing.T) {
	validate := func(_ context.Context, _ string) (uuid.UUID, error) {
...
func TestBearerAuthMiddleware_ExcludedPath_SkipsAuth(t *testing.T) {
	validate := func(_ context.Context, _ string) (uuid.UUID, error) {
